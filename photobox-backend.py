...
async def print_image(websocket, base64_image, brightness='0', contrast='-5'):
    try:
        ...
        job_id = subprocess.call(['convert inline:/home/pi/temp.b64 -resize 1000x384 -rotate "90" -density 203 -brightness-contrast {}x{} -remap pattern:gray50 -dither Riemersma ps:- | lp -d ZJ-58 -s'.format(brightness, contrast)], shell=True)
