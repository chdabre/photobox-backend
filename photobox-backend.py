...
async def print_image(websocket, base64_image):
    ...
    job_id = subprocess.call(['convert inline:/home/pi/temp.b64 -resize x450 -brightness-contrast 50x-10 -dither FloydSteinberg -remap pattern:gray50 jpg:/dev/stdout | lp -s'], shell=True)
    await send_message({
        'event': 'printEnqueued',
        'jobId': str(job_id)
    })
